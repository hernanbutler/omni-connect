...
const MarketingDataGenerator = () => {
  ...
  const apellidos = ['García', 'López', 'Martínez', 'Rodríguez', 'González', 'Fernández', 'Sánchez', 'Pérez', 'Ramírez', 'Torres'];
  const ciudades = ['Lima', 'Arequipa', 'Cusco', 'Trujillo', 'Chiclayo', 'Piura', 'Iquitos', 'Huancayo', 'Tacna', 'Ica'];
  ...
  const generateInterests = () => {
    const allInterests = ['tecnología', 'moda', 'deportes', 'hogar', 'belleza', 'viajes', 'gastronomía', 'salud'];
